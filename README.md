...
- Portable pipes use the fork-owned [`pipe.json`](https://cryptii.enkiel.org/schemas/pipe.json) and [`brick.json`](https://cryptii.enkiel.org/schemas/brick.json) schemas.
